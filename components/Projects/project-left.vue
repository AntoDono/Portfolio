    ...
    <div class="flex container-flex">
        <div class="h-full flex items-center z-30 description max-w-[500px]">
            <div class="font-fenix text-white relative flex flex-col gap-y-1 move">
                ...
                <h3 class="text-white font-fenix underline decoration-dotted text-md font-bold ">{{subtitle}}</h3>
                <div class="description-bg p-8 rounded">
                    <p>{{description}}</p>
                </div>
                <div class="flex flex-row move-justify gap-x-3 w-full flex-wrap gap-y-2">
